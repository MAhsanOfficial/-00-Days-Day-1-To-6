...
//  Print that message.
const favNumber = 56;
let message1 = "is the Jersey Number King Babar Azam";
...
let names = ["Ahsan", "Danish", "Asad", "Sheraz", "Arsalan"];
...
let transportation = ["Suzuki 150cc", "Audi G-tron", "Honda Civic"];
